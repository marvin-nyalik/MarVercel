...
**Marvin PP** is a simple project to demonstrate my competence as a web developer by literally showcasing my development skills.
...
1. Clone this repository
   run `git clone https://github.com/marvin-nyalik/MarVercel.git`
...
> Run this command 'git clone https://github.com/marvin-nyalik/MarVercel.git'
<p align="right">(<a href="#readme-top">back to top</a>)</p>
